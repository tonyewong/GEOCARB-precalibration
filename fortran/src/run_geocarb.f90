...
!!!          113 PRINT *, "fE is: ", fE
        ...
        !temp_out(i) = GCM*log(RCO2) !! <-- THIS is the actual temperature change!
        temp_out(i) = GCM*log(RCO2) - Ws*t/570 !! <-- this has Ws built in so the temperature output is comparable to Mills et al windows
